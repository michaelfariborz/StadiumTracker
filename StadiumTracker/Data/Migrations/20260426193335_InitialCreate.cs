        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpponentTeam = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    Score = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StadiumVisits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StadiumVisits_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StadiumVisits_Stadiums_StadiumId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stadiums_Name_LeagueId",
                table: "Stadiums",
                columns: new[] { "Name", "LeagueId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StadiumVisits_StadiumId",
                table: "StadiumVisits",
                column: "StadiumId");

            migrationBuilder.CreateIndex(
                name: "IX_StadiumVisits_UserId",
                table: "StadiumVisits",
                column: "UserId");
        }
